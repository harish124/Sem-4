...
int main()
{
    ...
    for(int timer=0;timer<25;timer++)       //just give some random big value to the limit of the timer. (That limit should be greater than the max of the arrival time
    {
        bt[n]=9999;
        for(int j=0;j<n;j++)
        {
